...
const PaymentResult: React.FC = () => {
  ...
  useEffect(() => {
    const verifyPayment = async () => {
      try {
        // Forward all VNPAY parameters to backend for verification
        ...
        // Clear group order from localStorage after successful payment
        ...
        {result?.success ? (
                ...
                <div className="order-details-card">
                  ...
                  <div className="order-details-content">
                    ...
                    {result.transaction_no && (
                      <div className="order-detail-row with-border">
                        <span className="order-detail-label">Transaction</span>
              ...
              <div className="message-box success">
                <div className="message-box-content">
                  ...
                  <p className="message-text success">
                    ...
                    confirmed. You can track your order status in the Orders
                    page.
                  </p>
                </div>
              </div>
          ...
          <div className="result-card">
            ...
            <div className="error-header">
              ...
              <p className="header-message">We couldn't process your payment</p>
            </div>
