...
urlpatterns = [
    ...
    path("products/<int:product_id>/images/bulk-upload/", views.ProductImageBulkUploadView.as_view(), name="product_image_bulk_upload"),
    path("products/<int:product_id>/images/<int:pk>/", views.ProductImageDetailView.as_view(), name="product_image_detail"),
    path("products/<int:product_id>/images/<int:image_id>/set-primary/", views.ProductImageSetPrimaryView.as_view(), name="product_image_set_primary"),
]